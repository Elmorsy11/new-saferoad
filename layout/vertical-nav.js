  ...
  return (
    <>
      <Accordion as="ul" className="navbar-nav iq-main-menu">
        {urlsData?.map(({ path, label, icon }) => {
          return (
            <>
              <Accordion.Item key={path} as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
        ...
        {/* <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
          <Link href="/track" passHref={true}>
            <a>
              <div
                className={`${router.pathname === "/track" ? "active" : ""
                  } nav-link`}
              >
                <i className="icon">
                  <svg
        ...
        <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
          <Link href="/preventiveMaintenance" passHref={true}>
            <a>
              <div
                className={`${router.pathname === "/preventiveMaintenance" ? "active" : ""
                  } nav-link `}
              >
                <i className="icon">
                  <svg
        ...
        <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
          <Link href="/reports" passHref={true}>
            ...
            <a>
              <div
                className={`${router.pathname === "/reports" ? "active" : ""
                  } nav-link `}
              >
                <i className="icon">
                  <svg
        ...
        <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix="nav-item">
          <Link href="/driversManagement" passHref={true}>
            <a>
              <div
                className={`${router.pathname === "/driversManagement" ? "active" : ""
                  } nav-link `}
              >
                <i className="icon">
                  <svg
